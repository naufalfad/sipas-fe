    ...
    if (existingSub) {
      methods.reset({
        ...
        photo: {
          ...
          photoSouth: existingSub.photos?.photoSouth || undefined,
          photoEast: existingSub.photos?.photoEast || undefined,
          photoWest: existingSub.photos?.photoWest || undefined,
          photoAccess: existingSub.photos?.photoAccess || undefined,
        }
      });
    }
  }, [existingSub]);
